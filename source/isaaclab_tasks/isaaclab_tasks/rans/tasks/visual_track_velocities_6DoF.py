...
from isaaclab_tasks.rans import VisualTrackVelocities3DCfg
...
class VisualTrackVelocities3DTask(TaskCore):
    """
    ...
    def __init__(
        ...
        task_cfg: VisualTrackVelocities3DCfg = VisualTrackVelocities3DCfg(),
        task_uid: int = 0,
        num_envs: int = 1,
        device: str = "cuda",
