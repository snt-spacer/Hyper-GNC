...
# IntBall2
########################################################################################################################
# Hypernet Beta MTCR PCGrad
MODEL_PATHS=(
/workspace/isaaclab/logs/rsl_rl/multitask_memory_control_beta_pcgrad/2026-01-13_22-35-55_rsl-rl_ppo-beta-memory_GoToPose3D-TrackVelocities3D-GoThroughPoses3D-GoToPosition3DWithObstacles_IntBall2_r-0_seed-1/model_3999.pt
/workspace/isaaclab/logs/rsl_rl/multitask_memory_control_beta_pcgrad/2026-01-14_00-34-34_rsl-rl_ppo-beta-memory_GoToPose3D-TrackVelocities3D-GoThroughPoses3D-GoToPosition3DWithObstacles_IntBall2_r-0_seed-2/model_3999.pt
/workspace/isaaclab/logs/rsl_rl/multitask_memory_control_beta_pcgrad/2026-01-14_02-33-26_rsl-rl_ppo-beta-memory_GoToPose3D-TrackVelocities3D-GoThroughPoses3D-GoToPosition3DWithObstacles_IntBall2_r-0_seed-3/model_3999.pt
/workspace/isaaclab/logs/rsl_rl/multitask_memory_control_beta_pcgrad/2026-01-14_04-32-11_rsl-rl_ppo-beta-memory_GoToPose3D-TrackVelocities3D-GoThroughPoses3D-GoToPosition3DWithObstacles_IntBall2_r-0_seed-4/model_3999.pt
/workspace/isaaclab/logs/rsl_rl/multitask_memory_control_beta_pcgrad/2026-01-14_06-30-53_rsl-rl_ppo-beta-memory_GoToPose3D-TrackVelocities3D-GoThroughPoses3D-GoToPosition3DWithObstacles_IntBall2_r-0_seed-5/model_3999.pt
)



# # Hypernet Beta MTCR PCGrad Task ID
# MODEL_PATHS=()

# Hypernet Beta MTCR PCGrad SemEmb
# MODEL_PATHS=()
