...
CONFIG_PATH="/workspace/isaaclab/source/isaaclab_tasks/isaaclab_tasks/rans/environments/single_robot_multi_task/agents/rsl_rl_ppo-multi-critic_cfg.py"
...
do
    ...
    echo "Seed: $SEED"
    OUTPUT_FILE="${OUTPUT_LOGS_PATH}multi-critic-SemEmb_seed-${SEED}.txt"
    rm -f $OUTPUT_FILE
